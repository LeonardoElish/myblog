...
declare global {
  ...
  const MessageCenter: typeof import('./components/MessageCenter')['default']
  const Messages: typeof import('./components/apps/Messages')['default']
  const Notification: typeof import('./components/apps/Notification')['default']
  const Reader: typeof import('./components/apps/Finder')['default']
  ...
  const Window: typeof import('./components/WindowBasic/Window')['default']
  const WindowSettingIcon: typeof import('./components/apps/WindowSettingIcon')['default']
  const WindowSettings: typeof import('./components/WindowBasic/WindowSettings')['default']
